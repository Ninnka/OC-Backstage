        ...
        <template>
          <el-table
            ...
            <el-table-column
              ...
              label="出金编号"
              width="130"
              v-if="tableColumnShow.outMoneyNum"
              header-align="left">
            </el-table-column>
          ...
          <!--合计总计-->
           <div class="table-sum">
             <div> 
                ...
                <span>出金：{{ pageSum.recharge }}笔</span>
                <span>总手续费：{{ pageSum.sumFee}}</span>
                <span>总出金： ${{ pageSum.sumRecharge }}</span>
                <span>
            ...
            <div>
              ...
              <span>出金：{{ sum.recharge }}笔</span>
              <span>总手续费：{{ sum.sumFee }}</span>
              <span>总出金： ${{ sum.sumRecharge }}</span>
              <span>
                <p>未知：{{ sum.unknown }}</p>
                <p>成功：{{ sum.success }}</p>
              </span>
...
<script>
var tableField = ['出金编号', '用户', '时间', '余额 ', '手续费', '金额', '汇率', '状态', '说明'];
export default {
  name: 'RechargeRecord',
  components: {
  },
  ...
  methods: {
    ...
    tableDataAll () {
      return [{
        ...
        exchangeRate: 6.667,
        status: '通过',
        description: '审核通过 12:23:34万死亡我我是大集合啊啥的啊'
      }, {
        outMoneyNum: 'LS00000001',
        userName: '交易商',
        userNum: '某某某',
